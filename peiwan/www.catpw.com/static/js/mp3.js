$(function(){
    ...
    var musicImgsData = ['/skin/images/bg.jpg','/skin/images/bg1.jpg','/skin/images/bg2.jpg']    // 图片地址数组
    var musicNameData = ['出山','盗将行','归去来兮'];                   // 歌曲名数组
    var artistNameData = ['花粥/王胜娚','花粥/马雨阳','花粥']            // 创作歌手数组
    var musicUrls=['http://www.catpw.com/skin/images/m1.mp3','http://www.catpw.com/skin/images/m2.mp3','http://www.catpw.com/skin/images/m3.mp3'];// 歌曲mp3数组
    ...
    function playPause(){
        if(audio.paused){
            ...
            playPauseBtn.attr('class','btn  play-pause icon-zanting iconfont') // 显示播放按钮
            ...
            playPauseBtn.attr('class','btn play-pause icon-jiediankaishi iconfont'); // 显示暂停图标
    ...
    function selectTrack(flag){
        ...
        if( flag == 0 ){
            ...
            playPauseBtn.attr('class','btn play-pause icon-zanting iconfont') // 显示播放图标
        }
...
playPauseBtn.on('touchstart',playPause);
	            playPauseBtn.on('WeixinJSBridgeReady',playPause);
        playPauseBtn.on('DOMContentLoaded',playPause); // 点击播放/暂停 按钮，触发playPause函数
